...
{
    public class ScottHanselmanViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("ScottHanselmanDetail", item);
                        });
                }
        ...
        {
            return new ScottHanselmanDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("ScottHanselmanDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("ScottHanselmanList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ScottHanselmanDetail");
        }
    }
}
